 ...
 */
public class PlacesCardAdapter extends RecyclerView.Adapter<PlacesViewHolder> {
    Context context;
    ...
    public PlacesCardAdapter(Context context) {
    ...
    public PlacesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.list_item_places_cardview, parent, false);
